...
# -*- coding: utf-8 -*-
#
# cansrmapp documentation build configuration file, created by
...
init_file = os.path.join('..', 'cansrmapp', '__init__.py')
...
htmlhelp_basename = 'cansrmappdoc'
...
latex_documents = [
    (master_doc, 'cansrmapp.tex',
     u'cansrmapp Documentation',
     u'Mark Kelly', 'manual'),
]
