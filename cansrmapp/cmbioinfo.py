...
import os
opj=os.path.join
pref=os.path.split(__file__)[0]
GENEINFOPATH=opj(pref,'bioinfo_redistributed','Homo_sapiens_241103.gene_info')
GFFPATH=opj(pref,'bioinfo_redistributed','gff_reduced.gff.gz')
_gi=None
_s2e=None
_e2s=None
_ens2e=None
